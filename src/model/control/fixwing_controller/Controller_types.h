...
#ifndef DEFINED_TYPEDEF_FOR_struct_HQfLeQtLjxtu3IdJj406WE_
#define DEFINED_TYPEDEF_FOR_struct_HQfLeQtLjxtu3IdJj406WE_

typedef struct {
  uint32_T period;
  int8_T model_info[26];
} struct_HQfLeQtLjxtu3IdJj406WE;

#endif

#ifndef DEFINED_TYPEDEF_FOR_struct_ulVIkLBg2wNIc1YufVcJJE_
#define DEFINED_TYPEDEF_FOR_struct_ulVIkLBg2wNIc1YufVcJJE_
