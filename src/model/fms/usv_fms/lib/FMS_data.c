...
const ConstB_FMS_T FMS_ConstB = {
  1.9966471893352524,                  /* '<S42>/Sum' */
  0.0066943799901413165,               /* '<S42>/Multiply3' */
  0.99330562000985867,                 /* '<S42>/Sum4' */
  ...
  4U,                                  /* '<S33>/Data Type Conversion1' */
  5U,                                  /* '<S33>/Data Type Conversion2' */
  1U,                                  /* '<S30>/Data Type Conversion' */
  3U,                                  /* '<S30>/Data Type Conversion1' */
  3U,                                  /* '<S36>/Data Type Conversion' */
  16U,                                 /* '<S36>/Data Type Conversion1' */
